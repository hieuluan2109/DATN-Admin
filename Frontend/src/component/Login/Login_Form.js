...
class LoginForm extends Component {
    ...
    //   }
            ...
            //   console.log({email,password})
             ...
             // POST #2
            //  axios.post('http://localhost:8000/admin/login',{email:this.state.email,password:this.state.password}).then(res=>{
            //     console.log(res);
        ...
        return (
            <div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div> <input type="email" placeholder="Email" name="email" value={this.state.name} onChange={this.handleChange}></input></div>
                    <div><i id="lock" className="fa fa-lock" ></i></div>
                    <div><input type="password" placeholder="********" name="password" value={this.state.password} onChange={this.handleChange} ></input></div>
